...
public class GameBoard
{
	...
	// the Instance() accessor.  You can't instantiate this class outside this
	...
	// This processes the input command file, using the factory to make
	...
	// command event does.  We can add any commands we want and this code will
